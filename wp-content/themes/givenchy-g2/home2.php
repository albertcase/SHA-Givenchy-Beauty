		...
		<div id="container">
			<div id="content" role="main">
				...
				<div class="post-previews">
					...
					<?php 
					query_posts( array('cate' => array(207), 'posts_per_page' => 1, 'orderby' => 'rand'));
					...
					<div class="post-preview post-preview-3 home-citation" style="width: 340px; height: 350px;">
						...
						<div class="citation">
							<p><a href="<?php  echo get_permalink(); // echo get_category_link( $category->cat_ID ) ?>"><?php echo $citation; ?></a></p>
						</div>-->
