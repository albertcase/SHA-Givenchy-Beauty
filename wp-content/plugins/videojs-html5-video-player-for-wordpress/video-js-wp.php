  ...
  $videojs .= <<<_end_
    ...
    <div class="video-js-box">
      ...
      <object class="vjs-flash-fallback" width="{$width}" height="{$height}" type="application/x-shockwave-flash"
        data="http://releases.flowplayer.org/swf/flowplayer.commercial-3.2.1.swf">
        <param name="movie" value="http://releases.flowplayer.org/swf/flowplayer.commercial-3.2.1.swf" />
        <param name="allowfullscreen" value="true" />
        <param name="flashvars" value='config={"key":"$key", "playlist":[$flow_player_poster{"url": "$mp4" $flow_player_autoplay $flow_player_preload }]}' />
        {$image_fallback}
      </object>
    </video>
