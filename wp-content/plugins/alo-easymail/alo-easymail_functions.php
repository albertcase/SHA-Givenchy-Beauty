...
//edit : added all this for
  ...
  $error_email_incorrect 	= esc_js( alo_em___(__("邮件地址不正确", "alo-easymail")) );
  $error_name_empty 		= esc_js( alo_em___(__("邮件地址不能为空", "alo-easymail")) );
  ...
  $error_email_added		= esc_js( alo_em___(__("当前Email地址已使用", "alo-easymail")) );
  $error_email_activated	= esc_js( alo_em___(__("当前Email地址已使用", "alo-easymail")) );  
  $error_on_sending			= esc_js( alo_em___(__("发送失败，请重试", "alo-easymail")) );
  if ( get_option('alo_em_no_activation_mail') != "yes" ) {
			$txt_ok			= esc_js( alo_em___(__("非常感谢您订阅我们网站的电子期刊，您会最先获知新产品的发布以及关于纪梵希网站的各种激动人心的最新消息。", "alo-easymail")) );  
  } else {
  ...
  $txt_subscribe			= esc_js( alo_em___(__("Ok", "alo-easymail")) );
  $txt_sending				= esc_js( alo_em___(__("发送", "alo-easymail")) );
  ...
  alo_em_sack.setVar( "alo_em_opt_name", 'user');
...
add_action('wp_ajax_alo_em_pubblic_form_check', 'alo_em_pubblic_form_callback'); 
