 ...
 */
        ...
        $html .= "    <td><input type='text' name='alo_em_opt_name' value='user". $alo_em_opt_name ."' id='opt_name' maxlength='50' class='input-text' /></td>\n";
        $html .= "  </tr>\n";
        $html .= "  <tr>\n";
        ...
        $html .= "</tbody></table>\n";        
 		$html .= $lists_table; // add lists table     
 		$html .= $disclaimer_html;	
        $html .= "<input type='submit' name='submit' value='".__("ok", "alo-easymail")."' class='input-submit' />\n";
        $html .= "</form>\n";    
