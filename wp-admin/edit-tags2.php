...
combineWords="";
for(var i=0;i<document.getElementsByClassName("column-name").length;i++){
combineWords+=document.getElementsByClassName("column-name")[i].innerText+" ";
}
//alert(combineWords);
//document.getElementById("combineWords").innerText=combineWords;
</script>
<div id="combineWords" display="block" style="width:400px;height:400px">
<?php echo "<script type='text/javascript'>document.getElementById('combineWords').innerText=combineWords;</script>" ?>
