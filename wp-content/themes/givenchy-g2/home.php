		...
		<div id="container">
			<div id="content" role="main">
				...
				<div class="post-previews">
					...
					<?php 
						$size = array('width' => 345, 'height' => 290);
					?>
					...
					<!-- -------------------------------------------------------- -->
					<div class="post-preview post-preview-3 home-citation" style="width:340px;height:350px;">
					<?php 
					query_posts( array('cate' => 207, 'posts_per_page' => 1, 'orderby' => 'rand'));
					$category = get_category(207);?>
					<?php while ( have_posts() ) : the_post(); ?>
					
					<?php $thumbnailId = get_post_thumbnail_id();
					$thumbnailMetadata = wp_get_attachment_metadata($thumbnailId);
					$thumbnailSize = $thumbnailMetadata;
					
					
					?>
					<div class="post-preview post-preview-2 home-citation" style="width: 345px; height: 290px;margin-bottom:-1px;margin-left:15px;">
						...
						<div class="img-wrapper" style=" background-color: #000; left: <?php echo round(($size['width'] - $thumbnailSize['width']) / 2) ; ?>px; top: <?php echo round(($size['height'] - $thumbnailSize['height']) / 2) ; ?>px">
							...
							<h2 class="entry-title" style="width: 325px;">
					...
					<div class="post-preview post-preview-3 home-citation" style="width: 345px; height: 290px;">	
